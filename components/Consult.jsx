...
const Consult = () => {
  return (
    <div className="-mt-[80px]">
      <div className="lg:px-[100px] px-[50px] lg:max-w-[1100px] w-full lg:h-[150px] h-[400px] bg-[#6CB4EE] mx-auto rounded-3xl flex items-center">
        <div className="flex flex-col gap-y-10 lg:gap-y-0 lg:flex-row justify-between items-center w-full">
          ...
          <h4 className="text-sm mx-8 w-full font-semibold text-center lg:text-left">
